...
test('team report entry renders approved metrics and branch details in a child Drawer', () => {
  ...
  assert.match(source, /data-testid="team-report-overview-scroll"[^>]*class="[^"]*max-h-\[min\(18rem,38vh\)\][^"]*overflow-y-auto/)
  assert.match(source, /data-testid="team-report-branch-header"[^>]*class="[^"]*shrink-0/)
  assert.match(source, /data-testid="team-report-branch-scroll"[^>]*class="[^"]*min-h-0[^"]*flex-1[^"]*overflow-y-auto/)
