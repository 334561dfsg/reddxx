  ...
  <Teleport to="body">
    <Transition name="user-control-log-drawer" appear @after-enter="onAfterEnter" @after-leave="handleAfterLeave">
      <div
        ...
        :style="layerStyle"
      >
        <Transition name="user-control-log-drawer-panel" appear>
          <aside
            v-show="phase !== 'closing'"
            ref="drawerRef"
...
.user-control-log-drawer-panel-enter-active { transition: opacity 200ms ease-out, transform 200ms ease-out; }
.user-control-log-drawer-panel-leave-active { transition: opacity 150ms ease-in, transform 150ms ease-in; }
.user-control-log-drawer-enter-from,
.user-control-log-drawer-leave-to,
.user-control-log-drawer-panel-enter-from,
.user-control-log-drawer-panel-leave-to { opacity: 0; }
.user-control-log-drawer-panel-enter-from,
.user-control-log-drawer-panel-leave-to { transform: translateX(100%); }

@media (prefers-reduced-motion: reduce) {
  .user-control-log-drawer-enter-active,
  .user-control-log-drawer-leave-active,
  .user-control-log-drawer-panel-enter-active,
  .user-control-log-drawer-panel-leave-active { transition-duration: 50ms; }
  .user-control-log-drawer-panel-enter-from,
  .user-control-log-drawer-panel-leave-to { transform: none; }
}
</style>
