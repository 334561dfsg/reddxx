...
export const USER_OPERATION_ENTRIES = Object.freeze([
  ...
  { id: 'unfreeze-funds', title: '解冻后台冻结', description: '仅解除由后台资金冻结操作产生的冻结金额', group: 'funds', status: 'planned', risk: 'danger', handler: 'planned' },
  { id: 'deduct-funds', title: '划扣可用资金', description: '永久减少用户可用资产并生成划扣记录', group: 'funds', status: 'planned', risk: 'danger', handler: 'planned' },
